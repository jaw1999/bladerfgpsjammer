...
TX_GAIN_L1_DB = 60  # L1 needs max gain
TX_GAIN_L5_DB = 60  # L5 also maxed out  
...
def main():
    ...
    print(f"[*] TX Gain: L1={TX_GAIN_L1_DB}dB, L5={TX_GAIN_L5_DB}dB")
    ...
    try:
        ...
        print("[*] Transmitting on L1 and L5 simultaneously... (Press Ctrl+C to stop)")
